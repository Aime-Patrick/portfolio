...
const groupContinuous = (
  ...
  // Single continuous row (GitHub-style): don't split on the calendar-year boundary.
  if (singleRow) {
...
export const CalendarHeatmap = ({
  ...
  const yearRows = useMemo(
    () =>
      continuousMonths
        ? groupContinuous(dataWithLevels, weekStart, singleRow)
        : groupByYearAndMonth(dataWithLevels, weekStart, hasEmptyColumn),
    [dataWithLevels, weekStart, hasEmptyColumn, continuousMonths, singleRow],
  );
