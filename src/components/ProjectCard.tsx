  ...
  return (
    ...
    >
      ...
      <div className="project__content p-4 flex-1 flex flex-col">
        <span className="text-sm text-[#000000] dark:text-gray-500">{subtitle}</span>
        <h3 className="text-lg font-semibold mt-1 mb-2 text-[#000000] dark:text-white">{title}</h3>
        <p className="text-[#000000] dark:text-gray-300 flex-1">
